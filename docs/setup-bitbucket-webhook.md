...
7. **Custom headers**:
   - `Authorization: Bearer <your-team-token>` — the bearer the platform
     team handed you (same value stored in `team-keys.json`; see
     [`onboarding-a-team.md`](onboarding-a-team.md)).
8. **Save**.
